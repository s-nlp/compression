...
def ttm_alt_compress_bart_ffn_W(
    model,
    ranks,
    input_dims,
    output_dims,
    ...
    for part in [encoder]:
        for i, layer in enumerate(part.layers):
            if weight_int_e is None:
                ...
                tt_weight = ttclass.from_linear(layer.fc1, 
                    weight_int_e[i] / weight_count,
            ...
            if weight_out_e is None:
                ...
                ttclass = InvasiveFWTTCompressedLinear
                tt_weight = ttclass.from_linear(layer.fc2, 
                    weight_out_e[i] / weight_count,
